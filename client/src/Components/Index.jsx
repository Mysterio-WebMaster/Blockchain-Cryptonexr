    ...
    <div>
        {loading ? ( <Anime /> ): (
            ...
            <Container>
                ...
                <div className="intro">
                    <p className="animate__animated animate__bounce greet">Hello!!!</p>
                    <p className="animate__animated animate__fadeInLeft brand">Cryptonex</p>
                    <p className="animate__animated animate__fadeIn animate__delay-2s tag">Blockchain based Tech</p>
                    <hr className='animate__animated animate__fadeIn animate__delay-2s '/>
                    <h5 className='animate__animated animate__fadeIn animate__delay-2s desc'>Project-Title: Electronic Voting System based on Blockchain</h5>
                    
                    <p className='animate__animated animate__fadeIn animate__delay-2s '>Abstract: Building a secure electronic voting system that offers the fairness and privacy of current voting schemes, while providing the transparency and flexibility offered by electronic systems has been a challenge for a long time. We evaluate an application of blockchain as a service to implement distributed electronic voting systems. This website proposes a novel electronic voting system based on blockchain that addresses some of the limitations in existing systems and evaluates some of the popular blockchain frameworks for the purpose of constructing a blockchain-based e-voting system. </p>
                </div>
            </Container>
        </div>
